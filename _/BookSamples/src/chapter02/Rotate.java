...
//        q1.fromAngleAxis(50 * FastMath.DEG_TO_RAD, Vector3f.UNIT_X); // 50 deg
//        Quaternion q2 = new Quaternion();
//        q2.fromAngleAxis(40 * FastMath.DEG_TO_RAD, Vector3f.UNIT_X); // 40 deg
//        Quaternion q3 = new Quaternion();
//        q3.slerp(q1, q2, 0.5f);               // 0.5f = halfways between 50 and 40 deg
