...
/**
 * This example shows how to skip the default settings window, 
 * and configure app settings before the application starts.
 * Examples of AppSettings are fullscreen/windowed, color depth, resolution.
 */
